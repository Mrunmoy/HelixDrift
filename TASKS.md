...
## In Progress
- [ ] Add calibration command flow wiring (stationary/T-pose command interface) via SensorFusion patch + submodule bump
...
5. [ ] Add battery/health telemetry framing to mocap example path
